...
import chappie.modulus.common.ability.*;
...
public record AbilityType(AbilitySupplier supplier) {
    ...
    public static final Registry<AbilityType> REGISTRY = FabricRegistryBuilder.create(ABILITY_TYPES).buildAndRegister();
    ...
    public static final AbilityType FLIGHT = AbilityType.register("flight", FlightAbility::new);
    public static final AbilityType SPEED = AbilityType.register("speed", SpeedAbility::new);
    public static final AbilityType GLOW = AbilityType.register("glow", GlowAbility::new);
