...
public class ModRegistries {
    ...
    private static Attribute registerAttribute(String name, Attribute attribute) {
        return Registry.register(BuiltInRegistries.ATTRIBUTE, Modulus.id(name), attribute);
    }
}
